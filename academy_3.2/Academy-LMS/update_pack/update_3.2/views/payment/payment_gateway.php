...
<div class="container">
	...
	<div class="row justify-content-center">
		<div class="col-md-8">
			<div class="row">
				<div class="col-md-3">
					<p class="pb-2 payment-header"><b><?php echo get_phrase('payment'); ?></b> <?php echo get_phrase('gateway'); ?></p>
				...
				<div class="col-md-8">
					<div class="w-100">
						<p class="pb-2 payment-header"><b><?php echo get_phrase('order'); ?></b> <?php echo get_phrase('summary'); ?></p>
						<?php $counter = 0 ?>
